...
const staticAppName = process.env.NEXT_PUBLIC_APP_NAME || "VideoHub";

export const metadata: Metadata = {
  title: `${staticAppName} — 私人影片分享空間`,
  description: `Exclusive video streaming space for friends and family powered by ${staticAppName}.`,
  robots: {
    index: false,
    follow: false,
  },
